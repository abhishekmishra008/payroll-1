...
const app = (function () {
        ...
        const dataTable = (elementID, ajax = undefined, column = undefined, rowRenderCallback = undefined, initCompleteCallback = undefined) => {
            if (elementID !== undefined) {
                ...
                var d = new Date();
                var n = d.getTime();
                let filename = "Report"+n;
                object.dom= '<"top d-flex justify-content-between"<"left-col"l><"center-col"><"right-col mb-2 d-flex flex-column"fB>>rtip';
                object.buttons= [
                    {
                        extend: 'excel',
                        text:'Download List/Report',
                        title: filename
                    },
                ];
        ...
        const dataTableDynamic = (elementID, ajax = undefined, column = undefined, rowRenderCallback = undefined, initCompleteCallback = undefined) => {
        ...
        return {
            ...
            dataTableDynamic: (elementID, ajax = undefined, column = undefined, rowRenderCallback = undefined, initCompleteCallback = undefined) => dataTableDynamic(elementID, ajax, column, rowRenderCallback, initCompleteCallback),
