                                            ...
                                            <tr>
                                                <td><h5><b>3.Balance (1-2)<b></h5></td>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <input type="file" id="myfile5" name="myfile5" style="display:none" onchange="myFunction(5)">
                                                                    <input type="hidden" id="myfile5a" name="myfile5a">
                                                                </td>
                                                                <td id="sts5"></td>
                                                                </tr>
                                                                ...
                                                                <td>  <input type="hidden" placeholder="enter value" id="ded2" name="ded2"></td>
                                                                <td>Calculated</td>
                                                                <td></td>
                                                                <td>
                                                                    <select id="select6" onchange="check_file(6)"  style="display:none">
                                                                        <option value="1">Estimated</option>
                                                                        <option value="2">Actual</option> 
                                                                    </select><br>
                                                                    <input type="file" id="myfile6" name="myfile6" style="display:none" onchange="myFunction(6)">
                                                                    <input type="hidden" id="myfile6a" name="myfile6a">
                                                                </td>
                                                                <td id="sts6"></td>
                                                                </tr>
                                                                ...
                                                                <tr>
                                                                    <td><h5><b>5.Aggregate of 4 (a to c) </b></h5></td>
                                                                    <td></td>
                                                                    <td>calculated</td>
                                                                    <td></td>
                                                                    <td></td>
                                                                ...
                                                                <tr>
                                                                    <td><h5><b>6.Income chargeable under the Head ‘Salaries’(3-5)</b></h5></td>
                                                                    <td></td>
                                                                    <td>calculated</td>
                                                                    <td></td>
                                                                    <td></td>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <input type="file" id="myfile8" name="myfile8" style="display:none" onchange="myFunction(8)">
                                                                    <input type="hidden" id="myfile8a" name="myfile8a">
                                                                </td>
                                                                <td id="sts8"></td>
                                                                </tr>
                                                                <tr>
                                                                    <td><h5><b>8. Gross total income  (6+7) </b></h5></td>
                                                                    <td></td>
                                                                    <td></td>
                                                                    <td></td>
                                                                    <td></td>
                                                                ...
                                                                <tr>
                                                                    <td><h5><b>9. Deductions Under Chapter VIA </b></h5></td>
                                                                    <td></td>
                                                                    <td>Calculated</td>
                                                                    <td></td>
                                                                    <td></td>
                                                                ...
                                                                <tr>
                                                                    <td><lable>i)</lable> <label id="gmt_text1" name="gmt_text1">Providant Fund</label></td>
                                                                <td><input type="number" class="qty1" placeholder="enter Gross Amount" id="gamt1" name="gmat1"> <br>
                                                                    <input type="hidden" class="qty1" placeholder="enter Qualifying Amt" id="gamt2" name="gmat2"> <br>
                                                                    <input type="hidden" class="qty1" placeholder="enter Deductible Amt" id="gamt3" name="gmat3"></td>
                                                                <td>Calculated</td>
                                                                <td></td>
                                                                <td>
                                                                    <select id="select9" onchange="check_file(9)"  style="display:none">
                                                                        <option value="1">Estimated</option>
                                                                        <option value="2">Actual</option> 
                                                                    </select><br>
                                                                    <input type="file" id="myfile9" name="myfile9" style="display:none" onchange="myFunction(9)">
                                                                    <input type="hidden" id="myfile9a" name="myfile9a">
                                                                </td>
                                                                <td id="sts9"></td>
                                                                </tr>
                                                                ...
                                                                <td><input type="number" class="qty1"placeholder="enter Gross Amount" id="gamt21" name="gmat21"> <br>
                                                                    <input type="hidden"class="qty1" placeholder="enter Qualifying Amt" id="gamt22" name="gmat22"> <br>
                                                                    <input type="hidden"class="qty1" placeholder="enter Deductible Amt" id="gamt23" name="gmat23"></td>
                                                                <td></td>
                                                                <td></td>
                                                                <td>
                                                                ...
                                                                <td><input type="number"class="qty1" placeholder="enter Gross Amount" id="gamt31" name="gmat31"> <br>
                                                                    <input type="hidden" class="qty1"placeholder="enter Qualifying Amt" id="gamt32" name="gmat32"> <br>
                                                                    <input type="hidden"class="qty1" placeholder="enter Deductible Amt" id="gamt33" name="gmat33"></td>
                                                                <td></td>
                                                                <td></td>
                                                                <td>
                                                                    ...
                                                                    <input type="file" id="myfile11" name="myfile11" style="display:none" onchange="myFunction(11)">
                                                                    <input type="hidden" id="myfile11a" name="myfile11a">
                                                                </td>
                                                                <td id="sts11"></td>
                                                                </tr>
                                                                <tr>
                                                                ...
                                                                <tr>
                                                                    <td><lable>i)</lable> <input type="text" id="gmt_text3" placeholder="enter text" name="gmt_text3"></td>
                                                                <td><input type="number" placeholder="enter Gross Amount" id="sec21" name="sec21"> <br>
                                                                    <input type="hidden" placeholder="enter Qualifying Amt" id="sec22" name="sec22"> <br>
                                                                    <input type="hidden" placeholder="enter Deductible Amt" id="sec23" name="sec23"></td>
                                                                <td>Variable</td>
                                                                <td></td>
                                                                <td>
                                                                    ...
                                                                    <input type="file" id="myfile12" name="myfile12" style="display:none" onchange="myFunction(12)">
                                                                    <input type="hidden" id="myfile12a" name="myfile12a">
                                                                </td>
                                                                <td id="sts12"></td>
                                                                </tr>
                                                                <tr>
                                                                ...
                                                                <td><input type="number" placeholder="enter Gross Amount" id="sec31" name="sec31"> <br>
                                                                    <input type="hidden" placeholder="enter Qualifying Amt" id="sec32" name="sec32"> <br>
                                                                    <input type="hidden" placeholder="enter Deductible Amt" id="sec33" name="sec33"></td>
                                                                <td>Variable</td>
                                                                <td></td>
                                                                <td>
                                                                    ...
                                                                    <input type="file" id="myfile13" name="myfile13" style="display:none" onchange="myFunction(13)">
                                                                    <input type="hidden" id="myfile13a" name="myfile13a">
                                                                </td>
                                                                <td id="sts13"></td>
                                                                </tr>

                                                                <tr>
                                                                    <td><lable>d) Section 80CCD (1B)</lable>  </td>
                                                                <td><input type="number" placeholder="enter Gross Amount" id="sec41" name="sec41"> <br>
                                                                    <input type="hidden" placeholder="enter Qualifying Amt" id="sec42" name="sec42"> <br>

                                                                <td>Variable</td>
                                                                <td></td>
                                                                <td>
                                                                    <select id="select17" onchange="check_file(17)">
                                                                        <option value="1">Estimated</option>
                                                                        <option value="2">Actual</option> 
                                                                    </select><br>
                                                                    <input type="file" id="myfile17" name="myfile17" style="display:none" onchange="myFunction(17)">
                                                                    <input type="hidden" id="myfile17a" name="myfile17a">
                                                                </td>
                                                                <td id="sts17"></td>
                                                                </tr>
                                                                ...
                                                                <td><input type="number" placeholder="enter Gross Amount" id="secb11" name="secb11"> <br>
                                                                    <input type="hidden" placeholder="enter Qualifying Amt" id="secb12" name="secb12"> <br>
                                                                    <input type="hidden" placeholder="enter Deductible Amt" id="secb13" name="secb13"></td>
                                                                <td></td>
                                                                <td></td>
                                                                <td>
                                                                    ...
                                                                    <input type="file" id="myfile14" name="myfile14" style="display:none" onchange="myFunction(14)">
                                                                    <input type="hidden" id="myfile14a" name="myfile14a">
                                                                </td>
                                                                <td id="sts14"></td>
                                                                </tr>
                                                                <tr>
                                                                ...
                                                                <td> <input type="number" placeholder="enter Gross Amount" id="secb21" name="secb21"> <br>
                                                                    <input type="hidden" placeholder="enter Qualifying Amt" id="secb22" name="secb22"> <br>
                                                                    <input type="hidden" placeholder="enter Deductible Amt" id="secb23" name="secb23"></td>
                                                                <td></td>
                                                                <td></td>
                                                                <td>
                                                                    ...
                                                                    <input type="file" id="myfile15" name="myfile15" style="display:none" onchange="myFunction(15)">
                                                                    <input type="hidden" id="myfile15a" name="myfile15a">
                                                                </td>
                                                                <td id="sts15"></td>
                                                                </tr>
                                                                <tr>
                                                                ...
                                                                <td> <input type="number" placeholder="enter Gross Amount" id="secb31" name="secb31"> <br>
                                                                    <input type="hidden" placeholder="enter Qualifying Amt" id="secb32" name="secb32"> <br>
                                                                    <input type="hidden" placeholder="enter Deductible Amt" id="secb33" name="secb33"></td>
                                                                <td></td>
                                                                <td></td>
                                                                <td>
                                                                    ...
                                                                    <input type="file" id="myfile16" name="myfile16" style="display:none" onchange="myFunction(16)">
                                                                    <input type="hidden" id="myfile16a" name="myfile16a">
                                                                </td>
                                                                <td id="sts16"></td>
                                                                </tr>
                                                                <tr>
                                                                    <td><h5><b>10. Aggregate of deductible amount under chapter VI-A </b></h5></td>
                                                                    <td></td>
                                                                    <td>Calculated</td>
                                                                    <td></td>
                                                                    <td></td>
                                                                ...
                                                                <tr>
                                                                    <td><h5><b>11. Total Income (8-10 )</b></h5></td>
                                                                    <td></td>
                                                                    <td>Calculated</td>
                                                                    <td></td>
                                                                    <td></td>
                                                                ...
                                                                <tr>
                                                                    <td><h5><b>12. Tax on total Income </b></h5>
																				<table border="1">
																							  <tr>
																								<td>
																								  Salary
                                                                ...
                                                                <tr>
                                                                    <td><h5><b>13. Rebate U/S 87a </b></h5>(Rebate is 0 if tax on total income is greater than or equal to 12500)</td>
                                                                    <td></td>
                                                                    <td>Calculated</td>
                                                                    <td></td>
                                                                    <td></td>
                                                                ...
                                                                <tr>
                                                                    <td><h5><b>14. Tax Payable on total income (12-13) </b></h5></td>
                                                                    <td></td>
                                                                    <td>Calculated</td>
                                                                    <td></td>
                                                                    <td></td>
                                                                ...
                                                                <tr>
                                                                    <td><h5><b>15.Education & Health Cess 4%</b></h5></td>
                                                                    <td></td>
                                                                    <td>Calculated</td>
                                                                    <td></td>
                                                                    <td></td>
                                                                ...
                                                                <tr>
                                                                    <td><h5><b>16. Tax payable (14+15)</b></h5></td>
                                                                    <td></td>
                                                                    <td>Calculated</td>
                                                                    <td></td>
                                                                    <td></td>
                                                                ...
                                                                <tr>
                                                                    <td><h5><b>17. Relife Under Section 89 (attach details)</b></h5></td>
                                                                    <td><input type="number" placeholder="enter  Amount" id="sec17" name="sec17"> </td>
                                                                    <td>Variable</td>
                                                                    <td></td>
                                                                    <td>
                                                                        <select id="select18" onchange="check_file(18)">
                                                                            <option value="1">Estimated</option>
                                                                            <option value="2">Actual</option> 
                                                                        </select><br>
                                                                        <input type="file" id="myfile18" name="myfile18" style="display:none" onchange="myFunction(18)">
                                                                        <input type="hidden" id="myfile18a" name="myfile18a">
                                                                    </td>
                                                                    <td id="sts18"></td>
                                                                </tr>
                                                                <tr>
                                                                    <td><h5><b>18. Tax payable (16-17)</b></h5></td>
                                                                    <td></td>
                                                                    <td>Calculated</td>
                                                                    <td></td>
                                                                    <td></td>
                                                                ...
                                                                <tr>
                                                                    <td><h5><b>19.Tax Deducted at source U/S 192</b></h5></td>
                                                                    <td><input type="hidden" placeholder="enter  Amount" id="sec19" name="sec19"></td>
                                                                    <td>Calculated</td>
                                                                    <td></td>
                                                                    <td>
                                                                        <select id="select19" onchange="check_file(19)" style="display:none">
                                                                            <option value="1">Estimated</option>
                                                                            <option value="2">Actual</option> 
                                                                        </select><br>
                                                                        <input type="file" id="myfile19" name="myfile19" style="display:none" onchange="myFunction(19)">
                                                                        <input type="hidden" id="myfile19a" name="myfile19a">
                                                                    </td>
                                                                    <td id="sts19"></td>
                                                                </tr>
                                                                <tr>
                                                                    <td><h5><b>20. Tax payable / refundable (17-18)</b></h5></td>
                                                                    <td></td>
                                                                    <td>Calculated</td>
                                                                    <td></td>
                                                                    <td></td>
