                            ...
                            <div class="form-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="email" disabled="" id="firm_email_id" value="<?php echo $result_firm_data->firm_email_id; ?>" onkeyup="remove_error('firm_email_id')" placeholder="Office email id"   name="firm_email_id" data-required="1" class="form-control">
                                            </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control m-input" value="<?php echo $result_firm_data->boss_name; ?>" id="boss_name"  name="boss_name" onkeyup="remove_error('boss_name')" aria-describedby="emailHelp" placeholder="Firm boss name">
                                            </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="number" min="0" id="boss_mobile_no" value="<?php echo $result_firm_data->boss_mobile_no; ?>" name="boss_mobile_no" onkeyup="remove_error('boss_mobile_no')"data-required="1" class="form-control" placeholder="Firm Mobile Number">
                                            </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="email" id="boss_email_id"  value="<?php echo $result_firm_data->boss_email_id; ?>" name="boss_email_id" onkeyup="remove_error('boss_email_id')"  data-required="1" class="form-control" placeholder="Firm Boss Email Id">
                                            </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="number" min="0" id="firm_no_of_employee" value="<?php echo $result_firm_data->firm_no_of_employee; ?>" name="firm_no_of_employee" onkeyup="remove_error('firm_no_of_employee')" data-required="1" class="form-control" placeholder="No of Employee In Firm">
                                            </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" id="country" name="country" value="<?php echo $result_firm_data1->country; ?>" onkeyup="remove_error('country')"  data-required="1" class="form-control" placeholder="Enter Your Country">
                                            </div>
                                ...
                                <div class="row">
                                    <div class="portlet box grey-salsa">
                                        <div class="portlet-title">
                                            <div class="caption">
                                                <i class="fa fa-user"></i>Permission & Accessibility</div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <!--                                <div class="col-md-2">
                                                                        ...
                                                                        <div class="m-radio-inline">
                                                                            <label class="m-radio m-radio--solid">
                                                                                <input type="radio" name="firm_activity_status" id="firm_activity_status" value="<?php echo $result_firm_data1->firm_name; ?>" checked="" value="A">
                                                                                Yes
                                                                                <span></span>
                                                                            </label>
                                                                            <label class="m-radio m-radio--solid">
                                                                                <input type="radio" name="firm_activity_status" id="firm_activity_status" value="<?php echo $result_firm_data1->firm_name; ?>" value="D">
                                                                                No
                                                                                <span></span>
                                                                            </label>
                                                                        </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-2">
                                            ...
                                            <div class="m-radio-inline">
                                                <?php if ($result_firm_data->firm_activity_status == 'A') {
                                                    ?>
                                                    <label class="m-radio m-radio--solid">
                                                ...
                                                <?php } else { ?>
                                                    <label class="m-radio m-radio--solid">
                                                        <input type="radio" name="firm_activity_status" id="firm_activity_status"  value="A">
                                                        Active
                                                        <span></span>
                                                    </label>
                                                    <label class="m-radio m-radio--solid">
                                                        <input type="radio" name="firm_activity_status" id="firm_activity_status" checked="" value="D">
                                                        De-Active
                                                        <span></span>
                                                    </label>
                                                <?php }
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            <div class="m-radio-inline">
                                                <?php if ($result_firm_data1->is_employee == '1') {
                                                    ?>
                                                    <label class="m-radio">
                                                ...
                                                <?php } else { ?>
                                                    <label class="m-radio">
                                                        <input type="radio" name="is_emp" id="is_emp"  value="1">
                                                        Yes
                                                        <span></span>
                                                    </label>
                                                    <label class="m-radio">
                                                        <input type="radio" name="is_emp" id="is_emp"  checked="" value="0">
                                                        No
                                                        <span></span>
                                                    </label>
                                                <?php }
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            <div class="m-radio-inline">
                                                <?php if ($result_firm_data->due_date_creation_permitted == '1') { ?>
                                                    <label class="m-radio m-radio--solid">
                                                ...
                                                <?php } else { ?>
                                                    <label class="m-radio m-radio--solid">
                                                        <input type="radio" name="due_date_creation_permitted"  id="due_date_creation_permitted" value="1">
                                                        Yes
                                                        <span></span>
                                                    </label>
                                                    <label class="m-radio m-radio--solid">
                                                        <input type="radio" name="due_date_creation_permitted" id="due_date_creation_permitted" checked=""  value="0">
                                                        No
                                                        <span></span>
                                                    </label>
                                                <?php }
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            <?php if ($result_firm_data->task_creation_permitted == '1') { ?>
                                                <div class="m-radio-inline">
                                                    <label class="m-radio m-radio--solid">
                                            ...
                                            <?php } else { ?>
                                                <div class="m-radio-inline">
                                                    <label class="m-radio m-radio--solid">
                                                        <input type="radio" name="task_creation_permitted"  id="task_creation_permitted"  value="1">
                                                        Yes
                                                        <span></span>
                                                    </label>
                                                    <label class="m-radio m-radio--solid">
                                                        <input type="radio" name="task_creation_permitted"  id="task_creation_permitted" checked="" value="0">
                                                        No
                                                        <span></span>
                                                    </label>
                                                </div>
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            <div class="m-radio-inline">
                                                <?php if ($result_firm_data1->leave_approve_permission == '1') { ?>
                                                    <label class="m-radio m-radio--solid">
                                                ...
                                                <?php } else { ?>
                                                    <label class="m-radio m-radio--solid">
                                                        <input type="radio" name="leave_approve_permitted" id="leave_approve_permitted"  value="1">
                                                        Yes
                                                        <span></span>
                                                    </label>
                                                    <label class="m-radio m-radio--solid">
                                                        <input type="radio" name="leave_approve_permitted" id="leave_approve_permitted"  checked="" value="0">
                                                        No
                                                        <span></span>
                                                    </label>
                                                <?php } ?>
                                        ...
                                        <?php
                                        $create_task = $result_firm_data1->create_task_assignment;
                                        $str_arr = preg_split("/\:/", $create_task);
                                        $create_task_assignment_old = $str_arr[1]; //1 means yes,0 means no
                                        $vvv = explode(',', $create_task_assignment_old);
                                        $create_task_assignment = $vvv[0];

                                        $due_date_permission = $result_firm_data1->create_due_date_permission;
                                        $str_arr1 = preg_split("/\:/", $due_date_permission);
                                        $create_due_date_assignment_old = $str_arr[1]; //1 means yes,0 means no

                                        $vvv_new = explode(',', $create_due_date_assignment_old);
                                        $create_due_date_assignment = $vvv_new[0];

                                        $create_service_permission = $result_firm_data1->create_service_permission;
                                        $enquiry_generate_permission = $result_firm_data1->enquiry_generate_permission;
                                        ?>
                                        <div class="col-md-2">
                                            <label for="">
                                            ...
                                            <div class="m-radio-inline">
                                                <?php if ($create_task_assignment == '1') { ?>
                                                    <label class="m-radio m-radio--solid">
                                                ...
                                                <?php } else { ?>
                                                    <label class="m-radio m-radio--solid">
                                                        <input type="radio" name="create_task_assign_permit" id="create_task_assign_permit"  value="1">
                                                        Yes
                                                        <span></span>
                                                    </label>
                                                    <label class="m-radio m-radio--solid">
                                                        <input type="radio" name="create_task_assign_permit" id="create_task_assign_permit"  checked="" value="0">
                                                        No
                                                        <span></span>
                                                    </label>
                                                <?php } ?>
                                ...
                                <div class="row">
                                    <div class="form-group">
                                        <div class="col-md-2">
                                            <label for="">
                                                Due Date Assignment Creation
                                                <!--Create Due Date Assignment Permission-->
                                            </label>
                                            <div class="m-radio-inline">
                                                <?php if ($create_due_date_assignment == '1') { ?>
                                                    <label class="m-radio m-radio--solid">
                                                        <input type="radio" name="create_duedate_assign_permit" id="create_duedate_assign_permit" checked=""  value="1">
                                                        Yes
                                                        <span></span>
                                                    </label>
                                                    <label class="m-radio m-radio--solid">
                                                        <input type="radio" name="create_duedate_assign_permit" id="create_duedate_assign_permit"  value="0">
                                                        No
                                                        <span></span>
                                                    </label>
                                                <?php } else { ?>
                                                    <label class="m-radio m-radio--solid">
                                                        <input type="radio" name="create_duedate_assign_permit" id="create_duedate_assign_permit"   value="1">
                                                        Yes
                                                        <span></span>
                                                    </label>
                                                    <label class="m-radio m-radio--solid">
                                                        <input type="radio" name="create_duedate_assign_permit" id="create_duedate_assign_permit" checked=""  value="0">
                                                        No
                                                        <span></span>
                                                    </label>
                                                <?php } ?>
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            <div class="m-radio-inline">
                                                <?php if ($create_service_permission == '1') { ?>
                                                    <label class="m-radio m-radio--solid">
                                                ...
                                                <?php } else { ?>
                                                    <label class="m-radio m-radio--solid">
                                                        <input type="radio" name="create_service_permit" id="create_service_permit"   value="1">
                                                        Yes
                                                        <span></span>
                                                    </label>
                                                    <label class="m-radio m-radio--solid">
                                                        <input type="radio" name="create_service_permit" id="create_service_permit" checked="" value="0">
                                                        No
                                                        <span></span>
                                                    </label>
                                                <?php } ?>
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            <div class="m-radio-inline">
                                                <?php if ($enquiry_generate_permission == '1') { ?>
                                                    <label class="m-radio m-radio--solid">
                                                ...
                                                <?php } else { ?>
                                                    <label class="m-radio m-radio--solid">
                                                        <input type="radio" name="generate_enq_permit" id="generate_enq_permit"   value="1">
                                                        Yes
                                                        <span></span>
                                                    </label>
                                                    <label class="m-radio m-radio--solid">
                                                        <input type="radio" name="generate_enq_permit" id="generate_enq_permit" checked=""  value="0">
                                                        No
                                                        <span></span>
                                                    </label>
                                                <?php } ?>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        ?>
                                                        <input type="date" min="0" id="joining_date"  name="joining_date" value="<?php echo $newcompletionDate; ?>"  class="form-control" Placeholser="Joining date of Client Admin"> </div>
                                                ...
                                                <div id="prob_yes" style="display: block;">
                                                    <div class="col-md-3">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="Date" name="prob_date_first" value="<?php echo $result_firm_data1->probation_period_start_date; ?>" onchange="remove_error('prob_date_first')" id="prob_date_first"ata-required="1" class="form-control" placeholder="Completion Date"> 
                                                        </div>
                                                    ...
                                                    <div class="col-md-3">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="Date" name="prob_date_second"  value="<?php echo $result_firm_data1->probation_period_end_date; ?>" onchange="remove_error('prob_date_second')" id="prob_date_second"ata-required="1" class="form-control" placeholder="Completion Date"> 
                                                        </div>
                                                ...
                                                <div id="train_yes" style="display: block;">
                                                    <div class="col-md-3">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="Date" name="training_period_first" value="<?php echo $result_firm_data1->training_period_start_date; ?>" onchange="remove_error('training_period_first')" id="training_period_first"ata-required="1" class="form-control" placeholder="Completion Date"> 
                                                        </div>
                                                    ...
                                                    <div class="col-md-3">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="Date" name="training_period_second" value="<?php echo $result_firm_data1->training_period_end_date; ?>" onchange="remove_error('training_period_second')" id="training_period_second"ata-required="1" class="form-control" placeholder="Completion Date"> 
                                                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="m-radio-inline">
                                                ...
                                                <?php if ($result_desig_data->holiday_consider_in_leave == 0) { ?>
                                    ...
                                    <div class="row">
                                        ...
                                        <DIV class="col-md-2"><input type="number" min="1" value="<?php echo $numdays1; ?>" id="numofdays1" name="numofdays1" onkeyup="remove_error('leave1')" class="form-control" placeholder="No Of Days"></DIV>
                                        <DIV class="col-md-2"><input type="number" min="0" value="<?php echo $req_bfr1; ?>" id="request_before1" name="request_before1" onkeyup="remove_error('leave1')" class="form-control" placeholder="Request Before"></DIV>
                                        <DIV class="col-md-2"><input type="number" min="1" value="<?php echo $aprv_bfr1; ?>" id="approve_before1" name="approve_before1" onkeyup="remove_error('leave1')" class="form-control" placeholder="Approve Before"></DIV>
                                        <div class="col-md-1" id="leave1" name="leave1"><span class="required" id="leave_type1_error"></span></div>
                                    </DIV><br>
                                    <div class="row">
                                        ...
                                        <DIV class="col-md-2"><input type="number" min="1" value="<?php echo $numdays2; ?>" id="numofdays2" name="numofdays2" onkeyup="remove_error('numofdays2')" class="form-control" placeholder="No Of Days"></DIV>
                                    ...
                                    <div class="row">
                                        ...
                                        <DIV class="col-md-2"><input type="number" min="1" value="<?php echo $numdays3; ?>" id="numofdays3" name="numofdays3" onkeyup="remove_error('numofdays3')" class="form-control" placeholder="No Of Days"></DIV>
                                    ...
                                    <div class="row">
                                        ...
                                        <DIV class="col-md-2"><input type="number" min="1" value="<?php echo $numdays4; ?>" id="numofdays4" name="numofdays4" onkeyup="remove_error('numofdays4')" class="form-control" placeholder="No Of Days"></DIV>
                                        <DIV class="col-md-2"><input type="number" min="0" value="<?php echo $req_bfr4; ?>" id="request_before4" name="request_before4" onkeyup="remove_error('designation_name')" class="form-control" placeholder="Request Before"></DIV>
                                        <DIV class="col-md-2"><input type="number" min="1" value="<?php echo $aprv_bfr4; ?>" id="approve_before4" name="approve_before4" onkeyup="remove_error('designation_name')" class="form-control" placeholder="Approve Before"></DIV>
                                    </DIV><br>
                                    <div class="row">
                                        ...
                                        <DIV class="col-md-2"><input type="number" min="1"  value="<?php echo $numdays5; ?>"id="numofdays5" name="numofdays5" onkeyup="remove_error('numofdays5')" class="form-control" placeholder="No Of Days"></DIV>
                                        <DIV class="col-md-2"><input type="number" min="0" value="<?php echo $req_bfr5; ?>" id="request_before5" name="request_before5" onkeyup="remove_error('designation_name')" class="form-control" placeholder="Request Before"></DIV>
                                        <DIV class="col-md-2"><input type="number" min="1" value="<?php echo $aprv_bfr5; ?>" id="approve_before5" name="approve_before5" onkeyup="remove_error('designation_name')" class="form-control" placeholder="Approve Before"></DIV>
                                    </div><br>
                                    <div class="row">
                                        ...
                                        <DIV class="col-md-2"><input type="number" min="1" value="<?php echo $numdays6; ?>" id="numofdays6" name="numofdays6" onkeyup="remove_error('numofdays6')" class="form-control" placeholder="No Of Days"></DIV>
                                        <DIV class="col-md-2"><input type="number" min="0" value="<?php echo $req_bfr6; ?>" id="request_before6" name="request_before6" onkeyup="remove_error('designation_name')" class="form-control" placeholder="Request Before"></DIV>
                                        <DIV class="col-md-2"><input type="number" min="1" value="<?php echo $aprv_bfr6; ?>" id="approve_before6" name="approve_before6" onkeyup="remove_error('designation_name')" class="form-control" placeholder="Approve Before"></DIV>
                                    </DIV><br>
                                    <div class="row">
                                        ...
                                        <DIV class="col-md-2"><input type="number" min="1"  value="<?php echo $numdays7; ?>"id="numofdays7" name="numofdays7" onkeyup="remove_error('numofdays7')" class="form-control" placeholder="No Of Days"></DIV>
                                        <DIV class="col-md-2"><input type="number" min="0" value="<?php echo $req_bfr7; ?>" id="request_before7" name="request_before7" onkeyup="remove_error('designation_name')" class="form-control" placeholder="Request Before"></DIV>
                                        <DIV class="col-md-2"><input type="number" min="1" value="<?php echo $aprv_bfr7; ?>" id="approve_before7" name="approve_before7" onkeyup="remove_error('designation_name')" class="form-control" placeholder="Approve Before"></DIV>
