                ...
                <div class="col-md-8">
                    <div class="col-md-12">
                        <div class="note note-success">
                            ...
                            &nbsp;<span> Denied: </span></i><i class="fa fa-home" style="color:#af2626;font-size: 17px;"></i>
                            &nbsp; <br><span>Reg Att-</span>
                            <span> Req: </span><i class="fa fa-user-times" title="Missing Attendace Requested!" style="font-size: 15px;color:#bf8f37"></i>
                            &nbsp; <span> Accept: </span><i class="fa fa-user-times" title="Missing Attendace Accepted!" style="font-size: 15px;color:green"></i>
                            &nbsp; <span> Deny: </span><i class="fa fa-user-times" title="Missing Attendace Denied!" style="font-size: 15px;color:#af2626"></i>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <button class="btn-in" id="btnIn" onclick="punchIn()">
                            ...
                            <button class="btn-out" id="btnOut" onclick="punchOut()">
...
<script type="text/javascript">
    ...
    let punched = false, start = null, interval = null;
