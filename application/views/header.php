<!DOCTYPE html>
 <head>
        ...
        <link href="<?php echo base_url()."assets/"; ?>global/css/mystyle.css" rel="stylesheet" type="text/css">
            ...
            <nav class="navbar" role="navigation">
                <div class="container-fluid">
                    <div class="havbar-header">
                        <!-- BEGIN LOGO -->
                        <a id="index" class="navbar-brand">
                            <img src="<?php echo base_url()."assets/"; ?>global/img/CroppedRMTLogo.png" alt="Logo"> </a>
                        <!-- END LOGO -->
                         ...
                         <!--    <form class="search-form" action="extra_search.html" method="GET">
                            ...
                            <div class="btn-group-img btn-group">
                                <button type="button" class="btn btn-sm dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                                    <img src="http://localhost/NEWRMT/assets/layouts/layout5/img/avatar1.jpg" alt=""> </button>
