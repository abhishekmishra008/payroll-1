...
//		}
    ...
    public function get_missing_punch_data_hr1() {
        // dd($this->input->post_get('emp_id'));
    ...
    public function get_missing_punch_data_hr() {
        ...
        if($user_id == 'kimaya.koranne@ecovisrkca.com' || $user_id == 'pornima.bhingarde@ecovisrkca.com' || $user_id == 'deepa@rkabra.net' || $user_id == 'dr@ecovisrkca.com' || $user_id == 'drathi@ecovisrkca.com' || $user_id == 'drathi1@ecovisrkca.com') {
            $qr = $this->db->query("SELECT hr_authority from user_header_all where user_id='$user_id'");
            if ($this->db->affected_rows() > 0) {
                $res = $qr->row();
                $firm_id = $res->hr_authority;
